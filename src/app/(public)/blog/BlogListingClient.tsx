  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12 md:py-24">
      ...
      <div className="text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16 md:mb-20">
        <span className="inline-block px-4 sm:px-5 py-1.5 sm:py-2 rounded-full bg-linear-to-r from-brand-primary/10 to-brand-accent/10 text-brand-primary text-[8px] sm:text-[10px] font-black uppercase tracking-[0.3em] border border-brand-primary/20">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base md:text-lg font-medium leading-relaxed px-2 sm:px-0">
          Expert analysis, market trends, and luxury lifestyle inspiration from
          Mumbai&apos;s premier real estate consultants.
        </p>
      ...
      {filteredBlogs.length === 0 ? (
        <div className="bg-white p-8 sm:p-12 md:p-16 lg:p-24 rounded-3xl sm:rouded-4xl md:rounded-[3rem] text-center space-y-6 sm:space-y-8 border border-dashed border-gray-200 shadow-sm max-w-3xl mx-auto">
          <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-linear-to-br from-brand-primary/5 to-brand-accent/5 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-gray-400 font-medium leading-relaxed text-sm sm:text-base">
              ...
              Try searching for market trends, luxury, or South Mumbai.
            </p>
          </div>
          <button
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-8 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4 sm:pt-6 md:pt-8 border-t border-gray-100 flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-linear-to-br from-brand-primary/10 to-brand-accent/10 flex items-center justify-center font-black text-[8px] sm:text-[10px] text-brand-primary shrink-0">
                      RE
                    </div>
                    <span className="text-[8px] sm:text-[10px] font-black text-brand-dark uppercase tracking-widest">
                      {blog.author}
                    </span>
                  </div>
