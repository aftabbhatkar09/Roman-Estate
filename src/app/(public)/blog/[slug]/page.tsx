...
// Pre-renders every published post at build time. New posts published later
// still work — Next.js renders and caches them on their first visit.
    ...
    <article className="bg-white min-h-screen pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 sm:mt-12 md:mt-16 lg:mt-24 flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-20">
        <div className="lg:w-2/3">
          ...
          {/* Social Share */}
          <Reveal className="mt-12 sm:mt-16 md:mt-20 lg:mt-24 pt-6 sm:pt-8 md:pt-10 lg:pt-12 border-t border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 md:gap-8">
        ...
        <aside className="lg:w-1/3 space-y-8 sm:space-y-10 md:space-y-12">
          <Reveal className="bg-gray-50 p-6 sm:p-8 md:p-10 rounded-3xl sm:rounded-4xl md:rounded-[3rem] border border-gray-100 space-y-5 sm:space-y-6 md:space-y-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {[
                ...
                <span
                  key={tag}
                  className="px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 bg-white border border-gray-100 rounded-xl sm:rounded-2xl text-[8px] sm:text-[10px] font-black uppercase tracking-widest text-gray-500 hover:border-brand-primary hover:text-brand-primary cursor-pointer transition-all shadow-sm"
                >
                  {tag}
                </span>
              ))}
          ...
          <Reveal delay={150} className="bg-linear-to-br from-brand-dark to-brand-dark-light p-6 sm:p-8 md:p-10 lg:p-12 rounded-3xl sm:rounded-4xl md:rounded-[3rem] lg:rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group">
