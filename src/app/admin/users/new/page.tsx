    ...
    <div className="max-w-xl mx-auto space-y-6 pb-12">
      ...
      <form onSubmit={handleSubmit} className={CARD}>
        <div>
          ...
          <input type="text" required value={form.name} onChange={(e) => set("name", e.target.value)} placeholder="John Doe" className={FIELD} />
        </div>
        <div>
          <label className={LABEL}>Email Address *</label>
          <input type="email" required value={form.email} onChange={(e) => set("email", e.target.value)} placeholder="john@romanestate.com" className={FIELD} />
        </div>
        <div>
