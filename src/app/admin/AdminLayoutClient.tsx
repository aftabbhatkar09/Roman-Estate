...
function SidebarContent({
  ...
  const navItems =
    role === "super_admin" ? [...baseItems, ...superAdminItems] : baseItems;
        ...
        <header className="shrink-0 bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 sm:px-6 md:px-8 sticky top-0 z-20">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="w-8 h-8 rounded-full bg-linear-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm shadow-sm shrink-0">
