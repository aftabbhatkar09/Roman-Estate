    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="glass-morphism p-2.5 rounded-[2rem] shadow-2xl shadow-brand-primary/10 flex flex-col md:flex-row items-center gap-2">
        ...
        <button
          ...
          className="w-full md:w-auto premium-button-primary !rounded-[1.5rem] flex items-center justify-center gap-2 group"
        >
      ...
      <div className="mt-5 flex flex-wrap justify-center gap-4 text-white/80 text-sm">
        <span className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-brand-accent" /> Popular: South Mumbai
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-brand-accent" /> Bandra West
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-brand-accent" /> Worli Skyline
        </span>
      </div>
    </div>
  );
